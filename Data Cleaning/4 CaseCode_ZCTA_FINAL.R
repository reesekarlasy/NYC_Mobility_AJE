...
zcta_tests_mta_acs$median_age <- (zcta_tests_mta_acs$B01001_023 + zcta_tests_mta_acs$B01001_024 + zcta_tests_mta_acs$B01001_025   + zcta_tests_mta_acs$B01001_047 + zcta_tests_mta_acs$B01001_048 + zcta_tests_mta_acs$B01001_049)/zcta_tests_mta_acs$total_population*10
...
zcta_tests_mta_acs$Median_Income <- zcta_tests_mta_acs$Median_Income1/10000
...
zcta_tests_mta_acs$essential_both <- zcta_tests_mta_acs$essential_both*10
...
zcta_tests_mta_acs$essential <- zcta_tests_mta_acs$essential*10
...
zcta_tests_mta_acs$health <- zcta_tests_mta_acs$health*10
...
zcta_tests_mta_acs$healthins <- zcta_tests_mta_acs$healthins*10
...
zcta_tests_mta_acs$minority <- zcta_tests_mta_acs$minority*10
...
zcta_tests_mta_acs$hs <- zcta_tests_mta_acs$hs*10
...
zcta_tests_mta_acs_nosi$April_11_Reduction <- zcta_tests_mta_acs_nosi$April_11_Reduction/10
